...
<head>
    ...
    <title>@yield('title', 'Kasir') — TokoKu POS</title>
...
<aside class="sidebar">
    ...
    <a href="{{ route('kasir.index') }}"    class="nav-item {{ request()->routeIs('kasir.index') ? 'active' : '' }}">
        <i class="fa fa-cash-register"></i> Kasir
    </a>
    <a href="{{ route('kasir.riwayat') }}"  class="nav-item {{ request()->routeIs('kasir.riwayat') ? 'active' : '' }}">
...
<div class="main">
    <div class="topbar">
        ...
        <div class="topbar-info">
            <span><i class="fa fa-clock"></i> {{ now()->format('H:i') }} WIB</span>
    ...
    <div class="content">
        ...
        @endif
        @if(session('error'))
            <div class="alert alert-danger"><i class="fa fa-circle-xmark"></i> {{ session('error') }}</div>
        @endif
